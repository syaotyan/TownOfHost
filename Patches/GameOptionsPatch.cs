...
namespace TownOfHost
{
    ...
    class ChanceChangePatch
    {
        public static void Postfix(RoleOptionSetting __instance)
        {
            ...
            {
                if (CustomRoles.Mafia.isEnable() || CustomRoles.SerialKiller.isEnable() || CustomRoles.Warlock.isEnable() || CustomRoles.BountyHunter.isEnable() || CustomRoles.ShapeMaster.isEnable() || CustomRoles.Camouflager.isEnable()) forced = true;
            }
